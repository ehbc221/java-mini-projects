 ...
 * Facture_CEE.java
 *
 * Created on 16 novembre 2005, 21:41
 */
 ...
 * @author  Sébastien
 */
public class Facture_CEE extends Facture implements Serializable {
    ...
    /** Creates a new instance of Facture_CEE */
    public Facture_CEE(String nom, String prenom, 
    ...
    int poidsNet, int poidsBrut, double total_TTC, double valeur_TVA, double total_HT) {
        super(nom, prenom, adresse, codePostal, ville, pays, telephone, fax, numeroFacture,
    ...
    public double[] Calculer() {
        ...
        calcul[21] = calcul[20] * 0.1639;
        
        calcul[22] = calcul[20] - calcul[21];
        
        return(calcul);
    }
    
    /**
     * Getter for property poidsNet.
     * @return Value of property poidsNet.
     */
    ...
    /**
     * Setter for property poidsNet.
     * @param poidsNet New value of property poidsNet.
     */
    ...
    /**
     * Getter for property poidsBrut.
     * @return Value of property poidsBrut.
     */
    ...
    /**
     * Setter for property poidsBrut.
     * @param poidsBrut New value of property poidsBrut.
     */
